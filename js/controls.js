...
export class ImageControl extends Control {
    ...
    calcDim() {
        let [w,h] = this.dim 
            ? f.scaleImage(this.img.width, this.img.height, this.dim.w, this.dim.h) 
...
export class TextCounterControl extends TextControl {
    constructor(params) {
        super(params);
...
export class ImageCounterControl extends Control {
    constructor(params) {
        super(params);
...
export class PauseOverlay extends BoxControl {
    constructor(params) {
        super(params);
        this.text = new TextControl(params);
        this.grid = params.grid;
        this.text.pos = f.point(this.grid.params.dim.w/2-this.text.dim.w/2, this.pos.y+20);
    }
...
export class LostOverlay extends BoxControl {
    constructor(params) {
        super(params);
        this.grid = params.grid;
    ...
    pack() {
        const imgDim = this.img.calcDim();
        this.img.pos = f.point(this.pos.x+this.dim.w/2-imgDim.w/2, this.pos.y+20);
        this.text.pos = f.point(this.pos.x+this.dim.w/2-this.text.dim.w/2, this.img.pos.y+this.img.dim.h+10);
        this.button.pos = f.point(this.pos.x+this.dim.w/2-this.button.dim.w/2, this.text.pos.y+this.text.dim.h+20);
        this.button.pack();
    }
}

export class IntroOverlay extends BoxControl {
    constructor(params) {
        super(params);
        this.text = new TextControl({...params});
        params.bgColor = null;
    ...
    pack() {
        const imgDim = this.img.calcDim();
        this.img.pos = f.point(this.dim.w/2-imgDim.w/2, this.pos.y+60);
        this.text.pos = f.point(this.dim.w/2-this.text.dim.w/2, this.img.pos.y+this.img.dim.h+10);
    }
}
